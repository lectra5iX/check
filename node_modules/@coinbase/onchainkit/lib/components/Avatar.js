...
const useAvatar = require('../hooks/useAvatar.js');
...
function Avatar({
  ...
  const _useName$useName = useName.useName(address),
    ensName = _useName$useName.ensName,
    isLoadingName = _useName$useName.isLoading;
  const _useAvatar$useAvatar = useAvatar.useAvatar(ensName),
    ensAvatar = _useAvatar$useAvatar.ensAvatar,
    isLoadingAvatar = _useAvatar$useAvatar.isLoading;
  if (isLoadingName || isLoadingAvatar) {
    return loadingComponent || /*#__PURE__*/jsxRuntime.jsx("svg", {
  ...
  if (!ensName || !ensAvatar) {
    return defaultComponent || /*#__PURE__*/jsxRuntime.jsx("svg", {
  ...
  return /*#__PURE__*/jsxRuntime.jsx("img", _objectSpread({
    className: className,
    loading: "lazy",
    width: "32",
    height: "32",
